...
const Auth = () => {
  return (
    <div>
      <section className="bg-gray-400 min-h-screen flex box-border justify-center items-center">
    <div className="bg-slate-100 rounded-2xl flex max-w-3xl p-5 items-center">
        ...
        <div className="md:block hidden w-1/2">
            <img className="rounded-2xl max-h-[1600px]" src="/details/quetson.png" alt="login form image" />
        </div>
    </div>
</section>
    </div>
