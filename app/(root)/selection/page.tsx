  ...
  return (
    <div className="bg-slate-100 w-full h-full ">
      ...
      <div className="grid grid-cols-3 p-4 md:p-10 sm:p-10 md:grid-cols-6 gap-8  h-[100px]"> 
        ...
        className="bg-white hover:text-white text-black shadow shadow-slate-300 sm:grid sm:grid-cols-2 md:grid md:grid-cols-3">Iphone</Button>
        <Button onClick={() => router.push('/watch')}
        className="bg-white hover:text-white text-black shadow shadow-slate-300 sm:grid sm:grid-cols-2 md:grid md:grid-cols-3">IWatch</Button>
        <Button onClick={() => router.push('/airpods')}
        className="bg-white hover:text-white text-black shadow shadow-slate-300 sm:grid sm:grid-cols-2 md:grid md:grid-cols-3">AirPods</Button>
        <Button onClick={() => router.push('/ipad')}
        className="bg-white hover:text-white text-black shadow shadow-slate-300 sm:grid sm:grid-cols-2 md:grid md:grid-cols-3">IPad</Button>
        <Button onClick={() => router.push('/other')}
        className="bg-white hover:text-white text-black shadow shadow-slate-300 sm:grid sm:grid-cols-2 md:grid md:grid-cols-3">Other Category</Button>
      </div>
      <div className=" py-12 ">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-lg shadow-lg p-8">
                <div className="relative overflow-hidden">
                    ...
                    <div className="absolute inset-0 bg-black opacity-40"></div>
                    <div className="absolute inset-0 flex items-center justify-center">
                        <button className="bg-white text-gray-900 py-2 px-6 rounded-full font-bold hover:bg-gray-300">Apple</button>
                    </div>
                </div>
