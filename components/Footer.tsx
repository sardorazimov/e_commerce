                ...
                <div className="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
                        ...
                        <div className="mt-8 grid grid-cols-2 gap-8 lg:mt-0 lg:grid-cols-5 lg:gap-y-16">
                            ...
                            <div className="col-span-2 lg:col-span-3 lg:flex lg:items-end">
                                <form className="w-full">
                                    ...
                                    <div
                                        className="border bg-white border-gray-100 p-2 focus-within:ring sm:flex sm:items-center sm:gap-4 rounded"
                                    >
                                        <Input 
                                          placeholder='your@gmail.com'
                                         className="w-full h-full border-none focus:border-transparent focus:ring-transparent sm:text-sm text-black rounded" />

                                        <button
                                            className="mt-1 w-full bg-green-500 px-6 py-3 text-sm font-bold uppercase tracking-wide text-white transition-none rounded hover:bg-teal-600 sm:mt-0 sm:w-auto sm:shrink-0"
                                        >
                                            Submit
                                        </button>
                                    </div>
                    ...
                    <div className="mt-8 border-t border-gray-100 pt-8">
                        <div className="sm:flex sm:justify-between">
                            <p className="text-xs text-white">&copy; 2022. E Commerce. All rights reserved.</p>
